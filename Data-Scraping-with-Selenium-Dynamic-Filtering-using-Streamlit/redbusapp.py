...
if web=="Home":
    ...
    slt.markdown('''Selenium: Selenium is a robust tool for automating web browsers, widely employed in web scraping to extract data from websites. It enables the simulation of human interactions with web pages—such as clicking buttons, filling out forms, and navigating through pages—facilitating the automated collection of targeted data.''')
